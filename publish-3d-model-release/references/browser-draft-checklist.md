...
6. If `printables_files` is non-empty, upload those files only to Printables' **Print Files** area. Do not upload them to Thingiverse. Confirm the detected printer, material, nozzle, layer height, duration, and weight before saving.
